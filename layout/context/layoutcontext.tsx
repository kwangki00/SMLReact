...
export const LayoutProvider = (props: ChildContainerProps) => {
  ...
  return (
    <LayoutContext.Provider value={value}>
      <>
        <Head>
          <title>Prim React</title>
          <meta charSet="UTF-8" />
          <meta name="description" content="PrimReact" />
          <meta name="robots" content="index, follow" />
          <meta name="viewport" content="initial-scale=1, width=device-width" />
          <meta property="og:type" content="website"></meta>
          <meta property="og:title" content="PrimeReact for Next.js"></meta>
          <meta property="og:url" content="https://www.primefaces.org/"></meta>
          <meta property="og:description" content="PrimReact" />
